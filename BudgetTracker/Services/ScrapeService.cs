...
namespace BudgetTracker.Services
{
    public class ScrapeService
    {
        ...
        public ScrapeService(Chrome chrome, ObjectRepository objectRepository, IEnumerable<GenericScraper> scrapers, ILogger<ScrapeService> logger)
        {
             ...
             *  new GenericScraper[]
            {
                new AlfabankScraper("2606450", "IndOoa3J1"),
                new AlfaPotokScraper("2606450", "IndOoa3J1"),
                new ModulDengiScraper("9251904159", "IndOoa3J2"), 
                new RaiffeisenScraper("diverofdark", "IndOoa3J2"),
                new LivecoinScraper("wecpvAn4AYNSQy4TfepYUFNWv5waQeF5", "BP6D1gCW33KeFFUhU4ym1YN63ZQzA7aD", logger),
                new PenenzaScraper("diverofdark@bk.ru", "IndOoa3J2"),
                new FxRateScraper(),
                new AlfaCapitalScraper("diverofdark", "IndOoa3J2", _objectRepository), 
                new ModulbankScraper("9251904159", "IndOoa3J1", _objectRepository), 
            }
             */
        }
